...
urlpatterns = [
    ...
    path('user_edit_blog/<int:blog_id>/', views.user_edit_blog, name='user_edit_blog'),
    ...
    path('blog_detail_while_editing/<int:pk>/', views.blog_detail_while_editing, name='blog_detail_while_editing'),
]
